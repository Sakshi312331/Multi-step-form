...
import SolarProductDetails from "./SolarProductDetails.jsx";
import Footer from "./components/SolarProduct/Footer.jsx";
import Header from "./components/SolarProduct/Header.jsx";
import PackageDetails from "./components/SolarProduct/PackageDetails.jsx";
import BoilerProductforgas from "./BoilerProductforgas.jsx";
import BoilerProductforoil from "./BoilerProductforoil.jsx";
  ...
  createRoutesFromElements(
    <>
      ...
      <Route path="/solar" element={<Solar />}>
        ...
        <Route
          path="/solar/solarFarmMounting"
          element={<SolarFarmMounting />}
        />
      ...
      <Route path="/SolarProduct" element={<SolarProductDetails />}></Route>
      <Route
        path="/BoilerProductforgas"
        element={<BoilerProductforgas />}
      ></Route>
      <Route
        path="/BoilerProductforoil"
        element={<BoilerProductforoil />}
      ></Route>
