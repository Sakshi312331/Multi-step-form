          ...
          <div className="flex text-center justify-between flex-wrap bg-white p-5">
            <div className="w-full lg:w-1/2 xl:w-1/3 mb-5">
              <div>
                <div className="overflow-hidden">
                  <img
                    src="/src/assets/Grant Euroflame House Boiler.png"
            ...
            <div className="w-full text-start lg:w-1/2 xl:w-1/3 text-left mb-5">
              <h6 className="text-lg font-semibold text-gray-700">
                Grant Euroflame House Boiler
              </h6>
              <p className="text-gray-700 mt-2">
                This package includes Grant Euroflamer A rated condensing boiler
              </p>
              <ul className="list-disc green-bullets space-y-5 green-bullets">
          ...
          <div className="relative p-8 bg-white w-full max-w-md m-auto flex-col flex rounded-lg shadow-lg">
            ...
            <section className="ideal-logic-boiler m-5">
              <div className="text-center mb-4">
                <h5> Grant Euroflame House Boiler</h5>
              </div>
...
export default EuroflameHouseBoiler;
