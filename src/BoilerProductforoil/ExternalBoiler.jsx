          ...
          <div className="flex text-center justify-between flex-wrap bg-white p-5">
            ...
            <div className="w-full text-start lg:w-1/2 xl:w-1/3 text-left mb-5">
              <h6 className="text-lg font-semibold text-gray-700">
                Grant Euroflame External Boiler & Hive Smart Thermostat
              </h6>
              <p className="text-gray-700 mt-2">
                This package includes Grant A rated condensing boiler Free Hive
                Smart Thermostat worth €520
              </p>
          ...
          <div className="relative p-8 bg-white w-full max-w-md m-auto flex-col flex rounded-lg shadow-lg">
            ...
            <section className="ideal-logic-boiler m-5">
              <div className="text-center mb-4">
                <h5>Grant Euroflame External Boiler & Hive Smart Thermostat</h5>
              </div>
              ...
              <div className="flex justify-end mt-4">
                <button
                  type="button"
                  className="bg-gray-500 text-white py-2 px-4 rounded mt-3 mb-5 mx-3"
                  onClick={handleClose}
                >
                  Close
                </button>
