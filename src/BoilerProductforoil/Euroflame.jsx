...
const Euroflame = () => {
  ...
  return (
    <div className="p-5">
      ...
      `}</style>
      <section className="BoxforOil ideal-logic-boiler m-5">
        <div className="widthofcontainer mx-auto shadow-lg">
          <div className="BoxforOil flex text-center justify-between flex-wrap bg-white p-5">
            <div className="w-full lg:w-1/2 xl:w-1/3 mb-5">
              <div>
                <div className="overflow-hidden">
                  <img
                    src="/src/assets/Grant Euroflame External Boiler.webp"
            ...
            <div className="w-full text-start lg:w-1/2 xl:w-1/3 text-left mb-5">
              <h6 className="text-lg font-semibold text-gray-700">
                Grant Euroflame External Boiler
              </h6>
              <p className="text-gray-700 mt-2">
                This package includes Grant A rated condensing boiler
              </p>
              <ul className="list-disc green-bullets space-y-5">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 overflow-auto bg-smoke-light flex">
          <div className="relative p-8 bg-white w-full max-w-md m-auto flex-col flex rounded-lg shadow-lg">
            <h5 className="text-lg font-semibold mb-4">Product Description</h5>
            <section className="ideal-logic-boiler m-5">
              <div className="text-center mb-4">
                <h5> Grant Euroflame External Boiler</h5>
              </div>
              <div className="container mx-auto">
                <div className="flex flex-col justify-evenly">
                  ...
                  <div className="w-full text-left ">
                    ...
                    <button
                      type="button"
                      className="bg-[#4ba4a1] text-white py-2 px-4 rounded mt-3 mb-5"
                      onClick={() =>
                        window.open(
              ...
              <div className="flex justify-end mt-4">
                ...
                <button
                  type="button"
                  className="bg-[#4ba4a1] text-white py-2 px-4 rounded mt-3 mb-5 mx-3"
                >
                  Save changes
                </button>
              </div>
