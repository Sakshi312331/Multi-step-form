...
import "../../BoilerProductforgas";
import { Link } from "react-router-dom";
import Modal from "./Modal";

const IdealLogicBoiler = () => {
  ...
  return (
    <>
      <h1 className="text-center mt-5 text-lg font-semibold">
        Excellent News! We have found the perfect replacement boilers for you
      </h1>
      <div className="p-5">
        <style jsx>{`
        ...
        <section className="ideal-logic-boiler m-5">
          <div className="widthofcontainer mx-auto shadow-lg ">
            <div className="flex text-center justify-between flex-wrap p-5">
              ...
              <div className="w-full text-start lg:w-1/2 xl:w-1/3 text-left mb-5">
                <h6 className="text-lg font-semibold text-gray-700">
                  Ideal Logic A Rated Max, Hive Smart Thermostat & 10-Year
                  Warranty
                </h6>
...
export default IdealLogicBoiler;
