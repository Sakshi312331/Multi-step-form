...
const IdealLogicBoilerproduct = () => {
  ...
  return (
    <>
      <h1 className="text-center mt-5 text-lg font-semibold">
        Not tickling your fancy? Don’t worry! We have plenty more packages that
        suit your needs!
      </h1>
      <div className="p-5">
        <style jsx>{`
              ...
              <div className="w-full lg:w-1/2 xl:w-1/3">
                ...
                >
                  <Link
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-white py-2 px-2 rounded mt-2 font-semibold"
                  >
                    <i class="fa-brands fa-youtube"></i>See Video
                  </Link>
                </button>
                <br />
                <button
...
export default IdealLogicBoilerproduct;
